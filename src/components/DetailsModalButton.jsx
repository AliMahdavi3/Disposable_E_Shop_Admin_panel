...
const DetailsModalButton = ({ rowData, setDetailsModal, setReInitialValues, className }) => {
    return (
        <button
            onClick={() => {
            ...
            className={`py-2 -me-3 ${className} hover:bg-violet-500 cursor-pointer bg-orange-400
