...
const Cards = () => {
    return (
        <div className='grid grid-cols-4 gap-3'>
            ...
            md:hover:bg-sky-700 cursor-pointer text-white bg-mgreen box_shadow rounded-xl h-32 w-full">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <FaProductHunt className='text-3xl lg:text-5xl' />
                </div>
            </div>
            <div className="col-span-4 md:col-span-1 transition duration-150 flex flex-col justify-center px-5
            md:hover:bg-amber-500 cursor-pointer text-white bg-amber-400 box_shadow rounded-xl h-32 w-full">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <FaCartArrowDown className='text-3xl lg:text-5xl' />
                </div>
            </div>
            <div className="col-span-4 md:col-span-1 transition duration-150 flex flex-col justify-center px-5
            md:hover:bg-teal-600 cursor-pointer text-white bg-teal-500 box_shadow rounded-xl h-32 w-full">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <FaMoneyCheckAlt className='text-3xl lg:text-5xl' />
                </div>
            </div>
            <div className="col-span-4 md:col-span-1 transition duration-150 flex flex-col justify-center px-5
            md:hover:bg-rose-500 cursor-pointer text-white bg-rose-400 box_shadow rounded-xl h-32 w-full">
                ...
                <div className='flex justify-between items-center'>
                    ...
                    <FaDollarSign className='text-3xl lg:text-5xl' />
                </div>
            </div>
        </div>
    )
